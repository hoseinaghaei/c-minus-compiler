...
class Grammar(object):
    ...
    next = [
        ...
        ("Declaration-list", NonTerminal.Declarationlist, [[NonTerminal.Declaration, NonTerminal.Declarationlist, ActionSymbol.INIT_ZERO], [NonTerminal.EPSILON]]),
        ("Declaration", NonTerminal.Declaration, [[NonTerminal.Declarationinitial, NonTerminal.Declarationprime]]),
        ("Declaration-initial", NonTerminal.Declarationinitial, [[NonTerminal.Typespecifier, ActionSymbol.SET_TYPE, Terminal.ID, ActionSymbol.DECLARE_ID]]),
        ("Declaration-prime", NonTerminal.Declarationprime, [[NonTerminal.Fundeclarationprime], [ActionSymbol.CHECK_VOID, NonTerminal.Vardeclarationprime]]),
        ...
        ("Fun-declaration-prime", NonTerminal.Fundeclarationprime,
         [[ActionSymbol.DECLARE_FUNCTION, Terminal.OPENPARENTHESIS, ActionSymbol.START_SCOPE, ActionSymbol.START_FUNC_SCOPE_FLAG, NonTerminal.Params, Terminal.CLOSEPARENTHESIS, NonTerminal.Compoundstmt, ActionSymbol.RETURN]]),
        ("Type-specifier", NonTerminal.Typespecifier, [[Terminal.VOID], [Terminal.INT]]),
        ("Params", NonTerminal.Params,
         [[Terminal.VOID], [Terminal.INT, Terminal.ID, ActionSymbol.DECLARE_ID, ActionSymbol.ADD_PARAM, NonTerminal.Paramprime, NonTerminal.Paramlist]]),
        ("Param-list", NonTerminal.Paramlist, [[NonTerminal.EPSILON], [Terminal.COMMA, NonTerminal.Param, NonTerminal.Paramlist]]),
        ("Param", NonTerminal.Param, [[NonTerminal.Declarationinitial, ActionSymbol.ADD_PARAM, NonTerminal.Paramprime]]),
        ...
        ("Compound-stmt", NonTerminal.Compoundstmt,
         [[Terminal.OPENACOLAD, ActionSymbol.START_SCOPE, NonTerminal.Declarationlist, NonTerminal.Statementlist, ActionSymbol.END_SCOPE, Terminal.CLOSEACOLAD]]),
        ...
        ("Selection-stmt", NonTerminal.Selectionstmt, [
            [Terminal.IF, Terminal.OPENPARENTHESIS, NonTerminal.Expression, Terminal.CLOSEPARENTHESIS, ActionSymbol.IF_SAVE,
             NonTerminal.Statement, NonTerminal.Elsestmt]]),
        ("Else-stmt", NonTerminal.Elsestmt, [[Terminal.ENDIF, ActionSymbol.ENDIF], [Terminal.ELSE, ActionSymbol.START_ELSE, NonTerminal.Statement, ActionSymbol.ENDIF_AFTER_ELSE, Terminal.ENDIF]]),
        ("Iteration-stmt", NonTerminal.Iterationstmt, [
            [Terminal.FOR, ActionSymbol.DEBUG, Terminal.OPENPARENTHESIS, NonTerminal.Expression, ActionSymbol.FOR_CHECK_CONDITION, Terminal.SEMICOLON, NonTerminal.Expression, ActionSymbol.IF_SAVE, ActionSymbol.IF_SAVE,
             Terminal.SEMICOLON, NonTerminal.Expression, ActionSymbol.FOR_JUMP_CHECK_CONDITION, Terminal.CLOSEPARENTHESIS, ActionSymbol.BREAK_SCOPE, NonTerminal.Statement, ActionSymbol.FOR_SAVE, ActionSymbol.BREAK_SAVE]]),
        ("Return-stmt", NonTerminal.Returnstmt, [[Terminal.RETURN, NonTerminal.Returnstmtprime, ActionSymbol.RETURN]]),
        ("Return-stmt-prime", NonTerminal.Returnstmtprime, [[Terminal.SEMICOLON], [NonTerminal.Expression, ActionSymbol.RETURN_VALUE, Terminal.SEMICOLON]]),
        ...
        ("B", NonTerminal.B, [[Terminal.EQUAL, NonTerminal.Expression, ActionSymbol.ASSIGN],
                         [Terminal.OPENBRACET, NonTerminal.Expression, ActionSymbol.ARRAY_INDEX, Terminal.CLOSEBRACET, NonTerminal.H],
        ...
        ("C", NonTerminal.C, [[NonTerminal.Relop, NonTerminal.Additiveexpression, ActionSymbol.EVAL_OPERATION], [NonTerminal.EPSILON]]),
        ("Relop", NonTerminal.Relop, [[Terminal.LESS, ActionSymbol.POPERATION], [Terminal.DOUBLEEQUAL, ActionSymbol.POPERATION]]),
        ...
        ("D", NonTerminal.D, [[NonTerminal.Addop, NonTerminal.Term, ActionSymbol.EVAL_OPERATION, NonTerminal.D], [NonTerminal.EPSILON]]),
        ("Addop", NonTerminal.Addop, [[Terminal.ADD, ActionSymbol.POPERATION], [Terminal.SUB, ActionSymbol.POPERATION]]),
        ...
        ("G", NonTerminal.G, [[Terminal.STAR, ActionSymbol.POPERATION, NonTerminal.Signedfactor, ActionSymbol.EVAL_OPERATION, NonTerminal.G], [NonTerminal.EPSILON]]),
        ("Signed-factor", NonTerminal.Signedfactor,
         [[Terminal.ADD, NonTerminal.Factor], [Terminal.SUB, NonTerminal.Factor, ActionSymbol.NEGATE], [NonTerminal.Factor]]),
        ...
        ("Signed-factor-zegond", NonTerminal.Signedfactorzegond,
         [[Terminal.ADD, NonTerminal.Factor], [Terminal.SUB, NonTerminal.Factor, ActionSymbol.NEGATE], [NonTerminal.Factorzegond]]),
        ...
        ("Var-call-prime", NonTerminal.Varcallprime,
         [[NonTerminal.Varprime], [Terminal.OPENPARENTHESIS, ActionSymbol.START_ARGS, NonTerminal.Args, ActionSymbol.END_ARGS, Terminal.CLOSEPARENTHESIS, ActionSymbol.CALL]]),
        ("Var-prime", NonTerminal.Varprime,
         [[Terminal.OPENBRACET, NonTerminal.Expression, ActionSymbol.ARRAY_INDEX, Terminal.CLOSEBRACET], [NonTerminal.EPSILON]]),
        ("Factor-prime", NonTerminal.Factorprime,
         [[Terminal.OPENPARENTHESIS, ActionSymbol.START_ARGS, NonTerminal.Args, ActionSymbol.END_ARGS, Terminal.CLOSEPARENTHESIS, ActionSymbol.CALL], [NonTerminal.EPSILON]]),
        ...
        ("Arg-list", NonTerminal.Arglist, [[NonTerminal.Expression, ActionSymbol.ADD_ARG, NonTerminal.Arglistprime]]),
        ("Arg-list-prime", NonTerminal.Arglistprime,
         [[Terminal.COMMA, NonTerminal.Expression, ActionSymbol.ADD_ARG, NonTerminal.Arglistprime], [NonTerminal.EPSILON]])
    ]
