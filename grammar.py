...
class Grammar(object):
    ...
    next = [
        ...
        ("Declaration-list", NonTerminal.Declarationlist, [[NonTerminal.Declaration, NonTerminal.Declarationlist], [NonTerminal.EPSILON]]),
        ("Declaration", NonTerminal.Declaration, [[NonTerminal.Declarationinitial, NonTerminal.Declarationprime]]),
        ("Declaration-initial", NonTerminal.Declarationinitial, [[NonTerminal.Typespecifier, Terminal.ID]]),
        ...
        ("Fun-declaration-prime", NonTerminal.Fundeclarationprime,
         [[Terminal.OPENPARENTHESIS, NonTerminal.Params, Terminal.CLOSEPARENTHESIS, NonTerminal.Compoundstmt]]),
        ("Type-specifier", NonTerminal.Typespecifier, [[Terminal.VOID], [Terminal.INT]]),
        ("Params", NonTerminal.Params,
         [[Terminal.VOID], [Terminal.INT, Terminal.ID, NonTerminal.Paramprime, NonTerminal.Paramlist]]),
        ...
        ("Compound-stmt", NonTerminal.Compoundstmt,
         [[Terminal.OPENACOLAD, NonTerminal.Declarationlist, NonTerminal.Statementlist, Terminal.CLOSEACOLAD]]),
        ...
        ("Expression-stmt", NonTerminal.Expressionstmt,
         [[Terminal.SEMICOLON], [Terminal.BREAK, Terminal.SEMICOLON], [NonTerminal.Expression, Terminal.SEMICOLON]]),
        ("Selection-stmt", NonTerminal.Selectionstmt, [
            [Terminal.IF, Terminal.OPENPARENTHESIS, NonTerminal.Expression, Terminal.CLOSEPARENTHESIS,
             NonTerminal.Statement, NonTerminal.Elsestmt]]),
        ("Else-stmt", NonTerminal.Elsestmt, [[Terminal.ENDIF], [Terminal.ELSE, NonTerminal.Statement, Terminal.ENDIF]]),
        ...
        ("Return-stmt", NonTerminal.Returnstmt, [[Terminal.RETURN, NonTerminal.Returnstmtprime]]),
        ("Return-stmt-prime", NonTerminal.Returnstmtprime, [[Terminal.SEMICOLON], [NonTerminal.Expression, Terminal.SEMICOLON]]),
        ("Expression", NonTerminal.Expression, [[NonTerminal.Simpleexpressionzegond], [Terminal.ID, NonTerminal.B]]),
        ("B", NonTerminal.B, [[Terminal.EQUAL, NonTerminal.Expression],
        ...
        ("C", NonTerminal.C, [[NonTerminal.Relop, NonTerminal.Additiveexpression], [NonTerminal.EPSILON]]),
        ("Relop", NonTerminal.Relop, [[Terminal.LESS], [Terminal.DOUBLEEQUAL]]),
        ...
        ("D", NonTerminal.D, [[NonTerminal.Addop, NonTerminal.Term, NonTerminal.D], [NonTerminal.EPSILON]]),
        ("Addop", NonTerminal.Addop, [[Terminal.ADD], [Terminal.SUB]]),
        ...
        ("G", NonTerminal.G, [[Terminal.STAR, NonTerminal.Signedfactor, NonTerminal.G], [NonTerminal.EPSILON]]),
        ("Signed-factor", NonTerminal.Signedfactor,
         [[Terminal.ADD, NonTerminal.Factor], [Terminal.SUB, NonTerminal.Factor], [NonTerminal.Factor]]),
        ...
        ("Signed-factor-zegond", NonTerminal.Signedfactorzegond,
         [[Terminal.ADD, NonTerminal.Factor], [Terminal.SUB, NonTerminal.Factor], [NonTerminal.Factorzegond]]),
        ("Factor", NonTerminal.Factor, [[Terminal.OPENPARENTHESIS, NonTerminal.Expression, Terminal.CLOSEPARENTHESIS],
                              [Terminal.ID, NonTerminal.Varcallprime], [Terminal.NUM]]),
        ("Var-call-prime", NonTerminal.Varcallprime,
         [[NonTerminal.Varprime], [Terminal.OPENPARENTHESIS, NonTerminal.Args, Terminal.CLOSEPARENTHESIS]]),
        ("Var-prime", NonTerminal.Varprime,
         [[Terminal.OPENBRACET, NonTerminal.Expression, Terminal.CLOSEBRACET], [NonTerminal.EPSILON]]),
        ...
        ("Factor-zegond", NonTerminal.Factorzegond,
         [[Terminal.OPENPARENTHESIS, NonTerminal.Expression, Terminal.CLOSEPARENTHESIS], [Terminal.NUM]]),
