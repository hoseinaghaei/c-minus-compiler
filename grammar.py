...
class Grammar(object):
    ...
    next = [
        ...
        ("Declaration-initial", NonTerminal.Declarationinitial, [[NonTerminal.Typespecifier, Terminal.ID, ActionSymbol.DECLARE_ID]]),
        ...
        ("Fun-declaration-prime", NonTerminal.Fundeclarationprime,
         [[ActionSymbol.DECLARE_FUNCTION, Terminal.OPENPARENTHESIS, ActionSymbol.START_SCOPE, ActionSymbol.START_SCOPE_FLAG, NonTerminal.Params, Terminal.CLOSEPARENTHESIS, NonTerminal.Compoundstmt, ActionSymbol.RETURN]]),
        ("Type-specifier", NonTerminal.Typespecifier, [[Terminal.VOID], [Terminal.INT]]),
        ("Params", NonTerminal.Params,
         [[Terminal.VOID], [Terminal.INT, Terminal.ID, ActionSymbol.DECLARE_ID, ActionSymbol.PID, NonTerminal.Paramprime, ActionSymbol.ADD_PARAM, NonTerminal.Paramlist]]),
        ("Param-list", NonTerminal.Paramlist, [[NonTerminal.EPSILON], [Terminal.COMMA, NonTerminal.Param, NonTerminal.Paramlist]]),
        ("Param", NonTerminal.Param, [[NonTerminal.Declarationinitial, ActionSymbol.PID, NonTerminal.Paramprime, ActionSymbol.ADD_PARAM]]),
